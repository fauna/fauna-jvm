...
public class FaunaRoleTest {
    ...
    public void testValidUserDefinedRoles() {
        ...
        assertEquals("@role/slartibartfast",
                FaunaRole.named("slartibartfast").toString());
    }

    @Test
    public void testInvalidUserDefinedRoles() {
        assertThrows(IllegalArgumentException.class,
                () -> FaunaRole.named("server").toString());
        assertThrows(IllegalArgumentException.class,
                () -> FaunaRole.named("1foo").toString());
        assertThrows(IllegalArgumentException.class,
                () -> FaunaRole.named("foo$").toString());
        assertThrows(IllegalArgumentException.class,
                () -> FaunaRole.named("foo bar").toString());
    }
