...
public class DefaultsTest {
    ...
    public void testTimeoutDefaults() {
        ...
        HttpRequest feedRequest = feedRequestBuilder.buildFeedRequest(FeedRequest.builder("token").build());
    ...
    public void testNullQueryTimeouts() {
        ...
        HttpRequest feedRequest = feedRequestBuilder.buildFeedRequest(FeedRequest.builder("token").timeout(null).build());
