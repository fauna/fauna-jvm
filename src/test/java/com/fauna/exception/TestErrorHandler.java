...
public class TestErrorHandler {
    ...
    public static Stream<TestArgs> testArgStream() {
        return Stream.of(
                new TestArgs(400, "unbound_variable",
                ...
                new TestArgs(400, "invalid_request",
                        InvalidRequestException.class),
                new TestArgs(400, "abort", AbortException.class),
                new TestArgs(400, "constraint_failure",
                        ConstraintFailureException.class),
                new TestArgs(401, "unauthorized",
                        AuthenticationException.class),
                new TestArgs(403, "forbidden", AuthorizationException.class),
                new TestArgs(409, "contended_transaction",
                        ContendedTransactionException.class),
                new TestArgs(440, "time_out", QueryTimeoutException.class),
                new TestArgs(500, "internal_error",
                        ServiceInternalException.class),
    ...
    public void testHandleBadRequest(TestArgs args)
        ...
        when(resp.body()).thenReturn(
                new ByteArrayInputStream(root.toString().getBytes()));
