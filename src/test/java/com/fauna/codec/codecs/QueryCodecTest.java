...
public class QueryCodecTest extends TestBase {
    public static final Codec<Query> QUERY_CODEC =
            DefaultCodecProvider.SINGLETON.get(Query.class);
    public static final Query QUERY = fql("let age = ${n}", Map.of("n", 42));

    public static Stream<Arguments> testCases() {
        return Stream.of(
                Arguments.of(TestType.Encode, QUERY_CODEC,
                        "{\"fql\":[\"let age = \",{\"value\":{\"@int\":\"42\"}}]}",
                        QUERY, null)
        );
    }
